      ...
      <div className="card-container">
        <div className="card">
          <Row xs={1} md={3} className="g-4">
            <Col>
              <Card>
                <a href="https://www.guvi.in/blog/skills-required-to-become-a-digital-marketer/">
                  <Card.Img variant="top" src="./images/career1.jpg" />
                </a>
                <Card.Body>
            ...
            <Col>
              <Card>
                <a href="https://www.guvi.in/blog/career-opportunities-in-digital-marketing/">
                  <Card.Img variant="top" src="./images/career2.jpg" />
                </a>
                <Card.Body>
            ...
            <Col>
              <Card>
                <a href="https://www.guvi.in/blog/top-career-opportunities-for-ui-ux-design/">
                  <Card.Img variant="top" src="./images/career3.jpg" />
                </a>
                <Card.Body>
