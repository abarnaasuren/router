    ...
    <div className="container">
      <div className="card-container">
        <Row xs={1} md={3} className="g-4">
          <Col>
            <Card>
              <Card.Img variant="top" src="./images/all1.png" />
              <Card.Body>
          ...
          <Col>
            <Card>
              <Card.Img variant="top" src="./images/all2.png" />
              <Card.Body>
          ...
          <Col>
            <Card>
              <Card.Img variant="top" src="./images/all3.png" />
              <Card.Body>
        ...
        <Row xs={1} md={3} className="g-4">
          <Col>
            <Card>
              <Card.Img variant="top" src="./images/all4.jpg" />
              <Card.Body>
          ...
          <Col>
            <Card>
              <Card.Img variant="top" src="./images/all5.jpg" />
              <Card.Body>
          ...
          <Col>
            <Card>
              <Card.Img variant="top" src="./images/all6.jpg" />
              <Card.Body>
