          ...
          <Col>
            <Card>
              <a href="https://www.guvi.in/blog/best-data-science-courses-for-beginners/">
                <Card.Img variant="top" src="./images/Data1.jpg" />
              </a>
              <Card.Body>
          ...
          <Col>
            <Card>
              <a href="https://www.guvi.in/blog/data-science-webinars-and-workshops/">
                <Card.Img variant="top" src="./images/Data2.jpg" />
              </a>
              <Card.Body>
          ...
          <Col>
            <Card>
              <a href="https://www.guvi.in/blog/10-best-data-science-frameworks/">
                <Card.Img variant="top" src="./images/Data3.jpg" />
              </a>
              <Card.Body>
                <Card.Title>10 Best Data Science Frameworks in 2023</Card.Title>
                <Card.Text>
                  Does data science fascinate you? If yes, you must definitely know about data science frameworks.
                </Card.Text>
          ...
          <Col>
            <Card>
              <a href="https://www.guvi.in/blog/top-7-must-watch-data-science-youtube-channels/">
                <Card.Img variant="top" src="./images/Data4.jpg" />
              </a>
              <Card.Body>
          ...
          <Col>
            <Card>
              <a href="https://www.guvi.in/blog/everything-about-data-scientist-salary-in-india/">
                <Card.Img variant="top" src="./images/Data5.jpg" />
              </a>
              <Card.Body>
          ...
          <Col>
            <Card>
              <a href="https://www.guvi.in/blog/how-long-would-it-take-to-learn-data-science/">
                <Card.Img variant="top" src="./images/Data6.jpg" />
              </a>
              <Card.Body>
